...
DIR_BACKUP="/media/facility-backup/Uniloc-backup/";
#filename to zip ans send zipped files
FILENAME="Uniloc_";
#Directory to get files
DIR_ARQUIVAR="/media/facility-empresa/uniloc";
...
MAILSUBJECT="Aviso FACILITY ! Backup enviado para nuvem de arquivos.";
